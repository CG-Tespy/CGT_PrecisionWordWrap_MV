...
* @help This is version 2.01.01 of this plugin. Tested with RMMV versions 1.5.1 and 
* 1.6.2. 
* 
* Requires version 2.01.03+ of the CGT WordWrapCore plugin. To have this 
* set as the wrapper right away, set the WordWrapCore's Wrapper param to "precision".
* 
